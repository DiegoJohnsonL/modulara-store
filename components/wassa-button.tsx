...
import { PHONE_NUMBER, MESSAGE } from "@/lib/consts";
import { useState, useEffect } from "react";

export default function WassaButton() {
    ...
    return (
        ...
        >
            <Button
                size="icon"
                className={`size-14 md:size-14 ring-2 ring-inset ring-white rounded-full ${
                    isScrolled ? "bg-green-600 hover:bg-green-700" : "bg-white/20 hover:bg-green-600"
